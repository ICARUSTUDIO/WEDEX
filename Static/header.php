        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex flex-1 max-w-2xl mx-8">
                    <form class="w-full flex" action="search.php" method="GET">
                        <input 
                            type="text" 
                            name="q"
                ...
                <ul class="flex items-center space-x-8 text-sm font-medium">
                    ...
                    <li class="relative group">
                        ...
                        <div class="absolute hidden group-hover:block bg-white shadow-lg rounded-lg mt-2 py-2 w-48">
                            <a href="category.php?cat=diagnostics" class="block px-4 py-2 hover:bg-gray-100">Diagnostics</a>
                            <a href="category.php?cat=mobility" class="block px-4 py-2 hover:bg-gray-100">Mobility Aids</a>
                            <a href="category.php?cat=respiratory" class="block px-4 py-2 hover:bg-gray-100">Respiratory</a>
                            <a href="category.php?cat=furniture" class="block px-4 py-2 hover:bg-gray-100">Medical Furniture</a>
                        </div>
                    </li>
