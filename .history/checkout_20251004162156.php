...
// Check if user is logged in (optional - depends on your business logic)
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input 
                                    ...
                                    name="first_name"
                                    value="<?php echo htmlspecialchars(explode(' ', $user_name)[0] ?? ''); ?>"
                                    required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
                                >
                            </div>
                            <div>
                                ...
                                <input 
                                    ...
                                    name="last_name"
                                    value="<?php echo htmlspecialchars(explode(' ', $user_name)[1] ?? ''); ?>"
                                    required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
                                >
                            </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-md p-6 sticky top-24">
                    ...
                    <button 
                        type="button" 
                        id="pay-button"
                        class="w-full bg-teal-600 text-white py-4 rounded-lg font-semibold hover:bg-teal-700 transition mb-4"
                    >
