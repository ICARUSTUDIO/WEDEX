...
if ($price_range) {
    switch($price_range) {
        case 'under50': $sql .= " AND price < 50000"; $count_sql .= " AND price < 50000"; break;
        case '50-100': $sql .= " AND price BETWEEN 50000 AND 100000"; $count_sql .= " AND price BETWEEN 50000 AND 100000"; break;
        case '100-500': $sql .= " AND price BETWEEN 100000 AND 500000"; $count_sql .= " AND price BETWEEN 100000 AND 500000"; break;
        case 'over500': $sql .= " AND price > 500000"; $count_sql .= " AND price > 500000"; break;
    }
}
if ($min_rating > 0) {
                    ...
                    <form method="GET" action="shop.php" id="filterForm">
                        ...
                        <div class="mb-6 pb-6 border-b">
                            ...
                            <div class="space-y-2">
                                ...
                                <label class="flex items-center text-sm text-gray-600 hover:text-teal-600 cursor-pointer py-1"><input type="radio" name="price" value="under50" <?php echo $price_range === 'under50' ? 'checked' : ''; ?> onchange="this.form.submit()" class="w-4 h-4 text-teal-600 mr-2 focus:ring-teal-500">Under ₦50k</label>
                                <label class="flex items-center text-sm text-gray-600 hover:text-teal-600 cursor-pointer py-1"><input type="radio" name="price" value="50-100" <?php echo $price_range === '50-100' ? 'checked' : ''; ?> onchange="this.form.submit()" class="w-4 h-4 text-teal-600 mr-2 focus:ring-teal-500">₦50k - ₦100k</label>
                                <label class="flex items-center text-sm text-gray-600 hover:text-teal-600 cursor-pointer py-1"><input type="radio" name="price" value="100-500" <?php echo $price_range === '100-500' ? 'checked' : ''; ?> onchange="this.form.submit()" class="w-4 h-4 text-teal-600 mr-2 focus:ring-teal-500">₦100k - ₦500k</label>
                                <label class="flex items-center text-sm text-gray-600 hover:text-teal-600 cursor-pointer py-1"><input type="radio" name="price" value="over500" <?php echo $price_range === 'over500' ? 'checked' : ''; ?> onchange="this.form.submit()" class="w-4 h-4 text-teal-600 mr-2 focus:ring-teal-500">Over ₦500k</label>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition group">
                        <div class="relative">
                            <a href="product.php?id=<?php echo $product['id']; ?>">
                                <img src="uploads/<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>" class="w-full h-48 sm:h-64 object-cover">
                            </a>
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between">
                                <p class="text-lg sm:text-xl font-bold text-gray-800 mb-2 sm:mb-0">₦<?php echo number_format($product['price'], 2); ?></p>
