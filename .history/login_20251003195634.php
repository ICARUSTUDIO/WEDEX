...
<body class="bg-gray-50">
    ...
    <script>
        ...
        const firebaseConfig = {
            apiKey: "AIzaSyC925zOfU30dCF0eaOYWO5Y0UwwkEAMvrQ",
            authDomain: "wedex-health.firebaseapp.com",
            projectId: "wedex-health",
            storageBucket: "wedex-health.appspot.com",
            messagingSenderId: "847504502071",
            appId: "1:847504502071:web:db77bdb35c45cbec2dbeb2",
            measurementId: "G-DLQ68XXJPT"
        };
        ...
        function handleAuthResult(user) {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    errorDiv.textContent = data.message || 'An error occurred on the server.';
        ...
        // 1. Event listener for the Google sign-in button
        googleSignInBtn.addEventListener('click', () => {
            console.log("Google Sign-In button clicked. Starting signInWithRedirect...");
            auth.signInWithRedirect(provider);
        });

        // 2. Check for redirect result when the page loads
        console.log("Checking for redirect result on page load...");
        auth.getRedirectResult()
            .then((result) => {
                console.log("getRedirectResult promise resolved. Result:", result);
                if (result && result.user) {
                    console.log("User found in redirect result:", result.user.displayName);
                    handleAuthResult(result.user);
                } else {
                    console.log("No user found in redirect result. This is normal on initial page load.");
                }
            }).catch((error) => {
                console.error("Error getting redirect result:", error);
                // Handle errors that occur during the redirect sign-in process
