...
define('FLUTTERWAVE_TEST_PUBLIC_KEY', 'FLWPUBK_TEST-your-test-public-key-here');
define('FLUTTERWAVE_TEST_SECRET_KEY', 'FLWSECK_TEST-your-test-secret-key-here');
define('FLUTTERWAVE_TEST_ENCRYPTION_KEY', 'FLWSECK_TEST-your-encryption-key-here');
...
define('FLUTTERWAVE_WEBHOOK_URL', 'https://yourdomain.com/flutterwave_webhook.php');

// Redirect URLs
define('FLUTTERWAVE_REDIRECT_URL', 'https://yourdomain.com/payment_callback.php');
