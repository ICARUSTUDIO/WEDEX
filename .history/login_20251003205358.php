...
<body class="bg-gray-50">
    ...
    <script>
        ...
        // Your web app's Firebase configuration (keeping Firebase authDomain for OAuth)
        ...
        // Event listener for the Google sign-in button (using popup instead of redirect)
