...
// Define the path to the Tinify library using the document root for better reliability.
// This assumes your project is directly inside htdocs (e.g., htdocs/WEDEX/)
