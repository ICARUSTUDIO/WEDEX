                ...
                <div class="bg-white rounded-lg shadow-lg p-6 md:p-8">
                    ...
                    <form method="POST" class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <label class="flex items-center"><input type="checkbox" class="w-4 h-4 text-teal-600 border-gray-300 rounded focus:ring-teal-500"><span class="ml-2 text-sm text-gray-600">Remember me</span></label>
    ...
    <script>
        ...
        function handleAuthResult(user) {
            ...
            fetch('firebase_auth.php', {
                ...
                body: JSON.stringify({ email: user.email, displayName: user.displayName, uid: user.uid })
            })
        ...
        googleSignInBtn.addEventListener('click', () => {
            auth.signInWithPopup(provider)
                .then((result) => handleAuthResult(result.user))
                .catch((error) => {
