    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 p-4 md:p-8">
                ...
                <!-- Product Image -->
                <div>
                    <div class="bg-gray-100 rounded-lg mb-4 h-80 md:h-96 flex items-center justify-center relative">
                ...
                <div>
                    ...
                    <p class="text-3xl md:text-4xl font-bold text-teal-600 mb-4">₦<?php echo number_format($product['price'], 2); ?></p>

                    <p class="text-gray-700 mb-6"><?php echo nl2br(htmlspecialchars($product['description'])); ?></p>
                    
                    <div class="space-y-3 mb-6">
                        <div class="flex items-center text-sm"><span class="font-semibold text-gray-700 w-24">Brand</span><span class="text-gray-700"><?php echo htmlspecialchars($product['brand']); ?></span></div>
                        <div class="flex items-center text-sm"><span class="font-semibold text-gray-700 w-24">SKU</span><span class="text-gray-700"><?php echo htmlspecialchars($product['sku']); ?></span></div>
                        <div class="flex items-center text-sm"><span class="font-semibold text-gray-700 w-24">Availability</span>
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-6">
                        ...
                        <button onclick="handleAddToCart()" class="flex-1 bg-teal-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-teal-700 transition flex items-center justify-center space-x-2">
