...
<body class="bg-gray-50">
    ...
    <script type="module">
        ...
        function handleAuthResult(user) {
            if (!user) return; // Do nothing if there's no user data

            // Send user data to our backend (firebase_auth.php)
        ...
        // This code runs automatically every time the login page is loaded.
        getRedirectResult(auth)
            .then((result) => {
                if (result) {
                    // This block runs ONLY if the user has just been redirected back from Google
